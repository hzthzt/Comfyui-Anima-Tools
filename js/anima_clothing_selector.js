...
async function openClothingSelectorModal(node, tagsWidget) {
    ...
    const tagFavorites = ensureSelectorTagFavorites(favoritesConfig.clothing, t("Default Tags"));
    ...
    const VIEW_STORAGE_KEY = "anima-clothing-selector-active-view";
    ...
    const cardsViewBtn = createEl("button", "anima-clothing-btn", t("Cards"));
    const tagsViewBtn = createEl("button", "anima-clothing-btn", t("Tags"));
